...
using EF.Common;
using EF.Fsm;
namespace EF.Procedure
{
    /// <summary>
    /// 流程管理器。
    /// </summary>
    public sealed class ProcedureManager : AEFManager, IProcedureManager
    {
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            ...
            m_ProcedureFsm = m_FsmManager.CreateFsm("Procedure", this, procedures);
        }
