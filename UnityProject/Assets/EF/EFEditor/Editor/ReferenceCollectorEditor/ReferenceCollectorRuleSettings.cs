    ...
    internal static class ReferenceCollectorRuleDefaults
    {
        ...
        internal static List<ReferenceCollectorRule> CreateDefaultRules()
        {
            return new List<ReferenceCollectorRule>
            {
                ...
                new ReferenceCollectorRule("Text", "TMPro.TextMeshProUGUI", true, "TextMeshProUGUI"),
                new ReferenceCollectorRule("Label", "TMPro.TextMeshProUGUI", true, "TextMeshProUGUI"),
                ...
                new ReferenceCollectorRule("Fill", "UnityEngine.UI.Image", true, "Image"),
                new ReferenceCollectorRule("Panel", "UnityEngine.GameObject", true, "GameObject"),
                new ReferenceCollectorRule("Template", "UnityEngine.GameObject", true, "GameObject"),
                new ReferenceCollectorRule("Bar", "UnityEngine.RectTransform", true, "RectTransform"),
                new ReferenceCollectorRule("Layer", "UnityEngine.RectTransform", true, "RectTransform"),
                new ReferenceCollectorRule("Zone", "UnityEngine.RectTransform", true, "RectTransform"),
                new ReferenceCollectorRule("Rect", "UnityEngine.RectTransform", true, "RectTransform"),
                new ReferenceCollectorRule("Sc", "UnityEngine.RectTransform", true, "RectTransform"),
