# resource-scene-loading Specification

## Purpose

定义 `IResourceManager.LoadSceneAsync` 与 `ISceneManager.LoadSceneAsync` 的场景激活控制契约，使其与 YooAsset 3.0 的 `allowSceneActivation` 参数语义一致。
