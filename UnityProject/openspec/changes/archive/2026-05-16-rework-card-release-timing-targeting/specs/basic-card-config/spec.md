...
- **AND** 该卡 MUST 至少挂两条 `TbCardEffect`：一条 `Kind = Damage`、`TriggerTiming = EnemyTurnStart`、`Value = 8`、`Duration = 0`；一条 `Kind = DamageDot`、`TriggerTiming = EnemyTurnStart` 或 `EnemyTurnEnd`、`Value = 2`、`Duration >= 1`
