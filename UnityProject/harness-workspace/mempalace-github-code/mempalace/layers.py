...
from .searcher import _search_collection, build_where_filter
...
class Layer3:
    ...
    def search(self, query: str, wing: str = None, room: str = None, n_results: int = 5) -> str:
        ...
        ranked = _search_collection(col, query=query, wing=wing, room=room, n_results=n_results)
        if "error" in ranked:
            return ranked["error"]
        ...
        for i, hit in enumerate(ranked["results"], 1):
